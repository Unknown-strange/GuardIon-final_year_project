...
export default function AddRedZoneScreen() {
  ...
  return (
    <ThemedView style={[styles.screen, { paddingTop: insets.top }]}>
      ...
      <View style={styles.titleRow}>
        <ThemedText style={styles.modalTitle}>Add Red Zone</ThemedText>
      ...
      <ScrollView
        ...
        <Image
          source={require('@/assets/mockups/red-zone-maps.png')}
          style={styles.map}
          contentFit="cover"
        />
        ...
        <View style={styles.select}>
          <ThemedText style={styles.selectText}>Restricted Zone (Danger/Warning)</ThemedText>
        ...
        <View style={styles.sliderRow}>
          ...
          <View style={[styles.track, { backgroundColor: GuardianColors.dangerMuted }]} />
          <Pressable style={styles.stepBtn} onPress={() => bump(STEP)}>
